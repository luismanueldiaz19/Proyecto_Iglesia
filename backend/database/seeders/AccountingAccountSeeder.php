...
class AccountingAccountSeeder extends Seeder
{
    ...
    public function run(): void {
        $accounts = [
            ...
            ['code' => '11021', 'name' => 'CoopCupadec', 'type' => 'Activo', 'is_transactional' => true],
            ['code' => '110211', 'name' => 'CoopCupadec (0300000151)', 'type' => 'Activo', 'is_transactional' => true],
            ['code' => '110212', 'name' => 'CoopCupadec (0100000153)', 'type' => 'Activo', 'is_transactional' => true],


            ['code' => '11022', 'name' => 'Banco Popular Dominicano', 'type' => 'Activo', 'is_transactional' => true],
            ['code' => '11023', 'name' => 'Banreservas', 'type' => 'Activo', 'is_transactional' => true],
            ['code' => '11024', 'name' => 'Banco BHD', 'type' => 'Activo', 'is_transactional' => true],
            ['code' => '1104', 'name' => 'Caja Chica', 'type' => 'Activo', 'is_transactional' => true],
            ['code' => '1105', 'name' => 'Inventario Librería', 'type' => 'Activo', 'is_transactional' => true],
            ['code' => '1106', 'name' => 'Inventario Cafetería', 'type' => 'Activo', 'is_transactional' => true],
