...
<head>
    ...
    <style>
        ...
        table.data-table {
            ...
            border-collapse: collapse;
            margin-bottom: 12px;
            font-size: 10px; /* Tamaño equilibrado */
            line-height: 1.3;
        }
        table.data-table th, table.data-table td {
            border: 1px solid #E5E7EB;
            padding: 5px 8px; /* Un poco más de aire para que respire */
            text-align: left;
            vertical-align: middle;
        }
        table.data-table th {
...
<div class="report-card">
    @include('pdf.components.header', [
        'title' => 'Reporte de Ingresos Provisionales',
    ...
    <div class="body-section">
        ...
        <table class="data-table">
            ...
            <tfoot>
                <tr class="total-row">
                    <td colspan="3" style="text-align: right; text-transform: uppercase; letter-spacing: 1px;">Total Ingresos:</td>
                    <td class="amount">${{ number_format($ingresos->sum('monto'), 2) }}</td>
                </tr>
            </tfoot>
        </table>
