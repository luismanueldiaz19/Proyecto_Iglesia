                        ...
                        rows: donations.map((donation) {
                          ...
                          return DataRow(
                            cells: [
                              DataCell(
                                Text(
                                  donation['id']?.toString().padLeft(5, '0') ?? '',
                                  style: TextStyle(
                              ...
                              DataCell(
                                Text(
                                  ...
                                  donation['created_at']?.toString().substring(0, 10) ?? '',
                                  style: TextStyle(
                                    color: Colors.grey.shade700,
                                    fontSize: 12,
                                  ),
                              ...
                              DataCell(
                                Tooltip(
                                  message: 'Cédula: ${donation['donor_cedula'] ?? 'N/A'}',
                                  child: Text(
                              ...
                              DataCell(
                                Tooltip(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      SizedBox(
                                        width: constraints.maxWidth * 0.2, // Limitar ancho
                                        child: Text(
