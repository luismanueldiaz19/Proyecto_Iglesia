...
class DashboardReconciliationChart extends StatelessWidget {
  final List<Map<String, dynamic>> chartData;

  const DashboardReconciliationChart({super.key, required this.chartData});
                ...
                barTouchData: BarTouchData(
                  ...
                  touchTooltipData: BarTouchTooltipData(
                    ...
                    getTooltipItem: (group, groupIndex, rod, rodIndex) {
                      ...
                      final value = rod.toY * rod.toY; // Recuperar valor original (sqrt revertido)
