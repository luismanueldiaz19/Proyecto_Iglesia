...
class NuevoIngresoDialog extends StatefulWidget {
  final Function(Map<String, dynamic>) onSave;

  const NuevoIngresoDialog({super.key, required this.onSave});
  ...
  static void show(
    ...
    showDialog(
      context: context,
      builder: (context) => NuevoIngresoDialog(onSave: onSave),
    );
  }

  @override
  State<NuevoIngresoDialog> createState() => _NuevoIngresoDialogState();
}

class _NuevoIngresoDialogState extends State<NuevoIngresoDialog> {
  ...
  void _submit() {
    if (_formKey.currentState!.validate()) {
      widget.onSave({
        'fecha_ingreso': _fechaController.text,
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: 'Concepto',
                  hintText: 'Descripción del ingreso',
                  prefixIcon: Icon(
                    Icons.description,
                    color: Colors.blue.shade600,
                  ),
